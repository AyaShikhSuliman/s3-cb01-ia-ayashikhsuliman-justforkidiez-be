package com.example.justyourkidiez.configuration.security.isauthenticated;
...
public class IsAuthenticatedAspect {
    ...
    @Pointcut("@annotation(com.example.justyourkidiez.configuration.security.isauthenticated.IsAuthenticated)")
    public void annotatedMethod() {
    }

    @Pointcut("@within(com.example.justyourkidiez.configuration.security.isauthenticated.IsAuthenticated)")
